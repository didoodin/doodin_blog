        ...
        <div class="px-6">
          <main class="pb-10">
            <article class="relative">
              <header class="mt-10 mb-10">
                <div class="flex flex-col items-center">
                  <p class="text-center text-sm font-semibold text-gray-400 md:text-sm">
                    <time datetime="2020-12-17T00:00:00.000Z">
                      2023년 03월 26일
                    </time>
                  </p>
                  <h1 class="mt-4 max-w-[18rem] text-center text-2xl font-extrabold tracking-tight text-black-500 md:max-w-full md:text-3xl">
                  Lorem ipsum
                  </h1>
                </div>{" "}
              ...
              <div class="prose prose-base prose-cyan w-full max-w-full prose-a:!text-cyan-500 prose-a:underline-offset-[3px] md:prose-lg nuxt-content">
              ...
              <div class="bg-gray-700 bg-opacity-40 w-full h-px my-4 mt-20 mb-10"></div>
              <div class="mb-14">
