      ...
      <header className="mt-10 mb-10">
        <div className="flex flex-col items-center">
          <p className="text-center text-sm font-semibold text-gray-400 md:text-sm">
            <time datetime="2020-12-17T00:00:00.000Z">2023년 03월 26일</time>
          </p>
        ...
        <div className="flex items-end justify-center mt-6 md:mt-6 text-center space-x-2">
          <button
            id="kakao-share-btn"
            title="카카오톡으로 공유하기"
            className="p-1">
          ...
          <button title="페이스북으로 공유하기" class="p-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fillRule="currentColor"
          ...
          <button
            id="clipboard"
            data-clipboard-text="https://www.peterkimzz.com/github-pages-nuxtjs/"
            title="링크 클립보드에 복사하기"
            className="p-1 focus:border-cyan-500"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
